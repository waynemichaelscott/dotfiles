# Generated by Powerlevel10k configuration wizard on 2026-03-05 at 09:10 GMT.
...
() {
  ...
  # Compact prompt for archie (small screen)
  ...
  # Compact right prompt for archie (small screen) - no context/time (shown in waybar)
  if [[ $(hostname) == "archie" ]]; then
